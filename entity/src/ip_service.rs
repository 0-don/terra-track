...
use super::sea_orm_active_enums::ServiceConf;
use super::sea_orm_active_enums::ServiceProtocol;
...
impl ColumnTrait for Column {
    ...
    fn def(&self) -> ColumnDef {
        match self {
            ...
            Self::Protocol => ServiceProtocol::db_type().def(),
            Self::Port => ColumnType::SmallInteger.def(),
            Self::Name => ColumnType::String(None).def(),
            Self::Conf => ServiceConf::db_type().def(),
